...
$('.reviews__prev').on('click', function (e) {
    e.preventDefault()
    $('.reviews__slader').slick('slickPrev')
})
$('.reviews__next').on('click', function (e) {
    e.preventDefault()
    $('.reviews__slader').slick('slickNext')
})
...
$(".header__nav--list a, .footer__nav--list a, .header__btn-box, .about__btn-box").on("click", function (e) {
  e.preventDefault();
